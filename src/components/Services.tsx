    ...
    tiers: [
      {
        tier: 'Essential',
        price: '৳8,000',
        features: ['1-hour session', 'Studio or outdoor', '15 retouched images', 'Online gallery'],
      },
      {
        tier: 'Signature',
        price: '৳15,000',
        features: ['2-hour session', 'Wardrobe consultation', '30 retouched images', 'Online gallery', '5 fine art prints'],
        popular: true,
      },
      {
        tier: 'Bespoke',
        price: '৳25,000',
        features: ['Half-day session', 'Styling & creative direction', '50+ retouched images', 'Online gallery', '10 fine art prints', 'Custom album'],
      },
    ],
  },
  {
    ...
    tiers: [
      {
        tier: 'Ceremony',
        price: '৳45,000',
        features: ['6-hour coverage', '1 photographer', '200+ edited images', 'Online gallery', 'Engagement mini-session'],
      },
      {
        tier: 'Full Day',
        price: '৳85,000',
        features: ['12-hour coverage', '2 photographers', '500+ edited images', 'Online gallery', 'Engagement session', 'Wedding album', 'Same-day highlights'],
        popular: true,
      },
      {
        tier: 'Legacy',
        price: '৳1,50,000',
        features: ['Multi-day coverage', '2 photographers + assistant', '800+ edited images', 'Online gallery', 'Engagement session', 'Premium album', 'Same-day highlights', 'Fine art prints collection'],
      },
    ],
  },
  {
    ...
    tiers: [
      {
        tier: 'Campaign',
        price: '৳25,000',
        features: ['Half-day shoot', '10 final images', 'Basic retouching', 'Commercial license'],
      },
      {
        tier: 'Editorial',
        price: '৳50,000',
        features: ['Full-day shoot', '25 final images', 'Advanced retouching', 'Commercial license', 'Art direction support'],
        popular: true,
      },
      {
        tier: 'Production',
        price: 'Custom',
        features: ['Multi-day production', 'Unlimited final images', 'Full post-production', 'Commercial license', 'Full creative team', 'Location scouting'],
      },
    ],
  },
];
